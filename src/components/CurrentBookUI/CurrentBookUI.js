    ...
    <div className="xl:w-1/4 md:w-1/2 p-4">
        ...
        <div className="flex flex-wrap mt-4 mb-6 -mx-3">
          ...
          <div className="px-3 mb-6 w-1/3 md:mb-0">                         
            <input
                ...
                id="page" type="number" placeholder="Page" defaultValue={book.pageNo} />
          </div>
        ...
        <div className="flex flex-wrap mt-8 -mx-3">
          ...
          <div className="px-3 w-1/4">
            <button className="px-4 py-2 font-semibold text-red-600 transition duration-500 ease-in-out transform bg-white border rounded-lg shadow-xl hover:text-white hover:border-red-600 hover:bg-red-600 focus:shadow-outline focus:outline-none">

    ...
    <footer className="mt-20 text-gray-700 bg-white border-t body-font">
      <div className="border-t border-gray-200">
        {/* <div className="container flex flex-col flex-wrap items-center justify-between p-5 mx-auto md:flex-row">
                    ...
                    <span className="ml-3 text-xl">Bestreads.</span>
                    </span>
                    <div className="flex flex-wrap items-center justify-center mx-auto text-base ">
                        <span className="justify-center mr-5 text-sm text-center text-gray-600 hover:text-gray-800">
                            Prices</span>
                        <span className="justify-center mr-5 text-sm text-center text-gray-600 hover:text-gray-800">
                            Contact</span>
                        <span className="justify-center mr-5 text-sm text-center text-gray-600 hover:text-gray-800">
                    ...
                    <div className="inline-flex items-center justify-center md:justify-start ">
                        <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                            <span className="text-blue-807 hover:text-blue-500">
                                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                    className="w-5 h-5" viewBox="0 0 24 24">
                                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                </svg>
                            </span>
                            <span className="ml-4 text-blue-870 hover:text-blue-500">
                                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                    className="w-5 h-5" viewBox="0 0 24 24">
                                    <path
